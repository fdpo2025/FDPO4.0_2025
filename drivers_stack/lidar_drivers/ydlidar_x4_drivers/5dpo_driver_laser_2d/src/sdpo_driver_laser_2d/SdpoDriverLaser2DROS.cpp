...
void SdpoDriverLaser2DROS::pubLaserData() {
  ...
  // Publica também a frequência de scan (usada pelo
  // motion_distortion_compensator). É um tópico latched, basta uma
  // publicação inicial — mas republicamos sempre para tolerar reinícios
  // do subscritor.
