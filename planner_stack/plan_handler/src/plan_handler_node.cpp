...
PlanHandlerNode::PlanHandlerNode(ros::NodeHandle& nh_): nh(nh_)
{
    ...
    // Inicializar vetores
    factory_coordinates.resize(139);
    warehouse_coordinates.resize(16);
    is_warehouse_coordinate.resize(139, false);
    is_process_warehouse.resize(139, false);
    is_input_warehouse.resize(139, false);
    is_output_warehouse.resize(139, false);
    ...
    if (nh.getParam("factory_coords", coords_list)) {
        if (coords_list.getType() == XmlRpc::XmlRpcValue::TypeArray) {
            for (int i = 0; i < coords_list.size() && i < 139; ++i) {
            ...
            ROS_ERROR("PlanHandlerNode: 'factory_coords' is not an array!");
        }
    } else {
    ...
    // ========================================================================
    // WAREHOUSE COORDINATES: lógicos/originais
    // ========================================================================
    // Input
    ...
    // Input warehouses duplicados
    is_warehouse_coordinate[100] = true;
    is_warehouse_coordinate[101] = true;
    is_warehouse_coordinate[102] = true;
    is_warehouse_coordinate[103] = true;
    is_input_warehouse[100] = true;
    is_input_warehouse[101] = true;
    is_input_warehouse[102] = true;
    is_input_warehouse[103] = true;

    // Process warehouses originais
    ...
    // Process warehouses duplicados
    is_warehouse_coordinate[113] = true;
    is_warehouse_coordinate[114] = true;
    is_warehouse_coordinate[117] = true;
    is_warehouse_coordinate[118] = true;
    is_warehouse_coordinate[120] = true;
    is_warehouse_coordinate[121] = true;
    is_warehouse_coordinate[124] = true;
    is_warehouse_coordinate[125] = true;

    is_process_warehouse[113] = true;
    is_process_warehouse[114] = true;
    is_process_warehouse[117] = true;
    is_process_warehouse[118] = true;
    is_process_warehouse[120] = true;
    is_process_warehouse[121] = true;
    is_process_warehouse[124] = true;
    is_process_warehouse[125] = true;

    // Output warehouses originais
    ...
    // Output warehouses duplicados
    is_warehouse_coordinate[135] = true;
    is_warehouse_coordinate[136] = true;
    is_warehouse_coordinate[137] = true;
    is_warehouse_coordinate[138] = true;
    is_output_warehouse[135] = true;
    is_output_warehouse[136] = true;
    is_output_warehouse[137] = true;
    is_output_warehouse[138] = true;
...
void PlanHandlerNode::plannedPathsCallback(const std_msgs::Int32MultiArray::ConstPtr& msg)
{
    ...
    for (const auto& value : msg->data) {
        ...
        if (is_current_warehouse) {
            ...
            // Primeiro nó do caminho: se for warehouse, ignora completamente
            if (is_first_node) {
            ...
            if (point.pick_box) {
                if (!control_points.empty()) {
                    ...
                    ROS_INFO("PlanHandlerNode: Set line_switch_ratio=0.95 for previous point (before pick warehouse)");
                }
                if (!plan_stack.empty()) {
